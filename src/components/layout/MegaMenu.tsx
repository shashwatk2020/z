...
const MegaMenu: React.FC<MegaMenuProps> = ({ activeCategory, onClose }) => {
  const toolCategories = {
    ...
    archive: {
      title: 'Archive Tools',
      tools: [
        { name: 'ZIP Archive Creator', path: '/tools/archive/zip-archive-creator' },
        { name: 'ZIP File Extractor', path: '/tools/archive/zip-file-extractor' },
        { name: 'RAR File Extractor', path: '/tools/archive/rar-file-extractor' },
        { name: '7-Zip Creator', path: '/tools/archive/7-zip-creator' },
        { name: 'TAR Archive Tool', path: '/tools/archive/tar-archive-tool' },
        { name: 'GZIP Compressor', path: '/tools/archive/gzip-compressor' },
        { name: 'Multi-format Extractor', path: '/tools/archive/multi-format-extractor' },
        { name: 'Batch Archive Creator', path: '/tools/archive/batch-archive-creator' },
        { name: 'Archive Format Converter', path: '/tools/archive/archive-format-converter' },
        { name: 'ZIP to RAR Converter', path: '/tools/archive/zip-to-rar-converter' },
        { name: 'RAR to ZIP Converter', path: '/tools/archive/rar-to-zip-converter' },
        { name: '7Z to ZIP Converter', path: '/tools/archive/7z-to-zip-converter' },
        { name: 'TAR to ZIP Converter', path: '/tools/archive/tar-to-zip-converter' },
        { name: 'ISO File Extractor', path: '/tools/archive/iso-file-extractor' },
        { name: 'CAB File Extractor', path: '/tools/archive/cab-file-extractor' },
        { name: 'DMG File Extractor', path: '/tools/archive/dmg-file-extractor' },
        { name: 'Archive Inspector', path: '/tools/archive/archive-inspector' },
        { name: 'File Size Analyzer', path: '/tools/archive/file-size-analyzer' },
        { name: 'Duplicate File Finder', path: '/tools/archive/duplicate-file-finder' },
        { name: 'Archive Repair Tool', path: '/tools/archive/archive-repair-tool' },
        { name: 'Password Recovery', path: '/tools/archive/password-recovery' },
        { name: 'Archive Splitter', path: '/tools/archive/archive-splitter' },
        { name: 'Archive Merger', path: '/tools/archive/archive-merger' },
        { name: 'Compression Analyzer', path: '/tools/archive/compression-analyzer' },
        { name: 'Backup Archive Creator', path: '/tools/archive/backup-archive-creator' },
        { name: 'Incremental Backup Tool', path: '/tools/archive/incremental-backup-tool' },
        { name: 'Backup Restoration Tool', path: '/tools/archive/backup-restoration-tool' },
        { name: 'Backup Verification', path: '/tools/archive/backup-verification' },
        { name: 'Backup Scheduler', path: '/tools/archive/backup-scheduler' },
        { name: 'Cloud Backup Sync', path: '/tools/archive/cloud-backup-sync' },
