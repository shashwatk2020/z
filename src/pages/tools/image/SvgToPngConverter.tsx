...
const SvgToPngConverter = () => {
  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (svgFiles.length !== files.length) {
      toast({
        title: "Invalid Files",
        description: "Please select only SVG files.",
        variant: "destructive"
      });
    }
  ...
  const convertToPng = async () => {
    if (selectedFiles.length === 0) {
      toast({
        ...
        description: "Please select SVG files to convert.",
        variant: "destructive"
      });
      return;
    }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Convert SVG vector graphics to PNG raster images with customizable dimensions.
          </p>
        </div>
        ...
        <div className="grid gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select one or more SVG files to convert to PNG format</CardDescription>
            </CardHeader>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            {formatFileSize(file.originalSize)} → {formatFileSize(file.newSize)} ({width}x{height}px)
                          </p>
                        </div>
                      </div>
                      <Button
