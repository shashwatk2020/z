...
const WebpConverter = () => {
  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (imageFiles.length !== files.length) {
      toast({
        title: "Invalid Files",
        description: "Please select image files (PNG, JPEG, GIF, etc.).",
        variant: "destructive"
      });
    }
      ...
      try {
        ...
        await new Promise((resolve, reject) => {
          img.onload = () => {
            ...
            const extension = outputFormat === 'webp' ? '.webp' : 
        ...
        <div className="grid gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select one or more image files to convert</CardDescription>
            </CardHeader>
