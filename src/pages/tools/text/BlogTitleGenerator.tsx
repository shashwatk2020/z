  ...
  const generateTitles = async () => {
    ...
    try {
      ...
      if (data && data.titles && Array.isArray(data.titles)) {
        ...
        toast({
          title: "Success",
          description: `Generated ${data.titles.length} blog titles!`,
        });
      } else {
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Generate viral, SEO-friendly blog titles that captivate your audience and boost your traffic with powerful AI.
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <Textarea
                  id="topic"
                  placeholder="Enter your blog post topic (e.g., 'the future of remote work')"
                  value={topic}
              ...
              <div>
                ...
                <Input
                  id="audience"
                  placeholder="Who are you writing for? (e.g., 'freelance writers')"
                  value={audience}
            ...
            <CardContent>
              {generatedTitles.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p>Generated blog titles will appear here</p>
        ...
        <Card className="mt-8">
          <CardHeader>
            <CardTitle>Tips for Great Blog Titles</CardTitle>
          </CardHeader>
          <CardContent>
