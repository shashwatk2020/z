...
import { Video, Upload, Download, Settings, Play, Maximize } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';

const MP4VideoConverter = () => {
    ...
    <Layout>
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold">MP4 Video Converter</h1>
          <p className="text-gray-600">Convert videos to MP4 with advanced settings</p>
        </div>
...
export default MP4VideoConverter;
