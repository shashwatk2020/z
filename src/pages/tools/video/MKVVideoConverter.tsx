    ...
    <Layout>
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold">MKV Video Converter</h1>
          <p className="text-gray-600">Convert videos to MKV with advanced settings</p>
        </div>
...
export default MKVVideoConverter;
