    ...
    <Layout>
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold">FLAC Audio Converter</h1>
          <p className="text-gray-600">Convert audio files to FLAC format with advanced settings</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={compressionLevel} onValueChange={setCompressionLevel}>
                  ...
                  <SelectContent>
                    <SelectItem value="0">0 (Fastest)</SelectItem>
                    <SelectItem value="5">5 (Default)</SelectItem>
                    <SelectItem value="8">8 (Highest)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
...
export default FLACAudioConverter;
