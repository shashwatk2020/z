  ...
  const stopRecording = () => {
    if (mediaRecorderRef.current && mediaRecorderRef.current.state === 'recording') {
      ...
      toast({
        ...
        description: "Interview recording has finished."
      });
    }
  };
    ...
    <Layout>
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold">Interview Recorder</h1>
          <p className="text-gray-600">Record high-quality audio for interviews</p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button asChild className="w-full">
                <a href={recordedAudioUrl} download="interview_recording.wav">
