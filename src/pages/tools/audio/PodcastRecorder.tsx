  ...
  const startRecording = async () => {
    try {
      ...
      toast({
        ...
        description: "Podcast recording is now active."
      });
  ...
  const stopRecording = () => {
    if (mediaRecorderRef.current && mediaRecorderRef.current.state === 'recording') {
      ...
      toast({
        ...
        description: "Podcast recording has finished."
      });
    }
  };
    ...
    <Layout>
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold">Podcast Recorder</h1>
          <p className="text-gray-600">Record high-quality audio for your podcasts</p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button asChild className="w-full">
                <a href={recordedAudioUrl} download="podcast_recording.mp3">
