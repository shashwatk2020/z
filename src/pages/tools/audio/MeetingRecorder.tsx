  ...
  const stopRecording = () => {
    if (mediaRecorderRef.current && mediaRecorderRef.current.state === 'recording') {
      ...
      toast({
        ...
        description: "Meeting recording has finished."
      });
    }
  };
    ...
    <Layout>
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-600">Record audio from your meetings for notes or transcription</p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button asChild className="w-full">
                <a href={recordedAudioUrl} download="meeting_recording.wav">
